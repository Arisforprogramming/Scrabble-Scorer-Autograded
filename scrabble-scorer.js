...
const scoringAlgorithms = 
 ...
 function scorerPrompt (userSelect) {
     userSelect = Number(input.question(question2));
  if (userSelect === 0){
...
function runProgram() {
  ...
  // let calculate1 = oldScrabbleScorer(wordInput);
  // console.log(calculate1);
  let calculate1 = scorerPrompt(wordInput);
  console.log(calculate1);
  // this line test for simplesScorer
  //let simpleScorerTest = console.log(simpleScorer("BANANA"));
  // this line test for vowelesScorer
  // let vowelBonusScorerTest = console.log(vowelBonusScorer("Elephant"));
  // console.log(vowelBonusScorerTest);
}
